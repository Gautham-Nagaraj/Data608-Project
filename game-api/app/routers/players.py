...
async def post_player(player_in: schemas.PlayerCreate, db: AsyncSession = Depends(get_db)):
    try:
        return await crud.create_player(db, player_in)
...
async def list_players(
    ...
    """
    return await crud.get_players(db, nickname=nickname, limit=limit, offset=offset)
